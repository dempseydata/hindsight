...
**Date:** 2026-08-01 · **Status:** accepted · **Decides:** [Lock the extraction contract](../../background/tickets/009-lock-the-extraction-contract.md), on the evidence of the [combined-vs-separate A/B](../../background/tickets/003-a-b-combined-vs-separate-extraction-prompts.md) and red-team test 3 (`definition/red-team-tests.md`)
